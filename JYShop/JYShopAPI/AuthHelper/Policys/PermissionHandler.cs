...
namespace JYShopAPI.AuthHelper
{
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        /// services 层注入
        /// </summary>
        public IUserRoleService RoleModulePermissionServices { get; set; }
        ...
        public PermissionHandler(IAuthenticationSchemeProvider schemes, IUserRoleService roleModulePermissionServices)
        {
            Schemes = schemes;
